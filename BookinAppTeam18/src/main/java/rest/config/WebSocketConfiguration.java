...
public class WebSocketConfiguration implements WebSocketMessageBrokerConfigurer {
    ...
    public void registerStompEndpoints(StompEndpointRegistry registry) {
        registry.addEndpoint("api/socket") // Definisemo endpoint koji ce klijenti koristiti da se povezu sa serverom.
    ...
    public void configureMessageBroker(MessageBrokerRegistry registry) {
        registry.setApplicationDestinationPrefixes("api/socket-subscriber") // Prefiks koji koji se koristi za mapiranje svih poruka.
                // Klijenti moraju da ga navedu kada salju poruku serveru.
                // Svaki URL bi pocinjao ovako: http://localhost:8080/socket-subscriber/…/…
                .enableSimpleBroker("api/socket-publisher"); // Definisanje topic-a (ruta) na koje klijenti mogu da se pretplate.
